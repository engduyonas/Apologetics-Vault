---
title: Is Jesus God’s Servant or Son? Addendum A
tradition: islam
slug: is-jesus-gods-servant-or-son-addendum-a
...
[In this section](<authors/shamoun/pais_6.html> "Opens internal link in current window") we will be citing specific Jewish sources to show that Christians are not the only ones claiming that texts such as Isaiah 52:13 are about the Messiah. We start off with the targums, which are Aramaic paraphrases of the Hebrew Bible:
...
For more on the Messiah’s exaltation and divine status see the following article: [How the Hebrew Bible Falsifies Islam Pt. 2](<authors/shamoun/hebrew_bible_falsifies_quran2.html> "Opens internal link in current window")

  
Time to proceed [to the next addendum](<authors/shamoun/pais_add_b.html> "Opens internal link in current window").
